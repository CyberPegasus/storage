...
train_split = 'datasets/kaist/split/train.txt'
...
json_save_name = write_path + 'instances_train.json' if one_class_mode else 'instances_train_multilabel.json'
